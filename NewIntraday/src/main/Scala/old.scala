...
object old {
  def main(args: Array[String]): Unit = {
    ...
    val jy_tt_Path = "D:\\DATA\\2.05-2.19\\all_fund_2021-02-18-15.txt"
    val hm_Path = "D:\\DATA\\2.05-2.19\\gz_0220.txt"
    val my_Path = "D:\\DATA\\2.05-2.19\\mayi.txt"
    ...
    val sql =
      """
        ...
        |(select *
        |from t0
        |where t0.time_int='2021-02-18')t5
        | join
        |(select *
        |from t1
        |where t1.Fgzrq = '2021-02-18')t6
        |on t5.fund_code = t6.Fjjdm
        | join
        |(select *
        |from t2
        |where t2.download_date='2021-02-18')t7

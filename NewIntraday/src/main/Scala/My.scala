  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.sql(
      """
        ...
        |concat(cast((sum(countmy) / 2692) * 100 as decimal(16,3)),'%')as `蚂蚁相反估计占比`,
        |sum(counttt)  as `天天相反个数`,
        |concat(cast((sum(counttt) / 2692) * 100 as decimal(16,3)),'%') as `天天相反估计占比`,
        |sum(countjy)  as `聚源相反个数`,
        |concat(cast((sum(countjy) / 2692) * 100 as decimal(16,3)),'%' )as `聚源相反估计占比`,
        |sum(counthm)  as `好买相反个数`,
        |concat(cast((sum(counthm) / 2692) * 100 as decimal(16,3)),'%') as `好买相反估计占比`
        |
        |from(
        |select
        |report_return,
      ...
      .option("header", "true")
      .format("CSV")
      .save("D:\\Result\\1.29-2.4\\Week_NoGrouping\\need1_opposite")*/
                        ...
                        //之前的
                            ...
                            spark.sql(
                              """
                                ...
                                |select
                                |'蚂蚁'           as `基金名称`,
                                |concat(cast(sum(ee1) / 2692 *100 as decimal(16,3)),'%') as `<=0.05%`,
                                |concat(cast(sum(ee2) / 2692 *100 as decimal(16,3)),'%') as `<=0.1% `,
                                |concat(cast(sum(ee3) / 2692 *100 as decimal(16,3)),'%') as `<=0.3% `,
                                |concat(cast(sum(ee4) / 2692 *100 as decimal(16,3)),'%') as `<=0.5% `,
                                |concat(cast(sum(ee5) / 2692 *100 as decimal(16,3)),'%') as `<=1%  ` ,
                                |concat(cast(sum(ee6) / 2692 *100 as decimal(16,3)),'%') as ` >1%   `
                                |from
                                |(
                                |select
                                ...
                                |select
                                |'天天'          as `基金名称`,
                                |concat(cast(sum(hh1) / 2692 *100 as decimal(16,3)),'%') as `<=0.05%`,
                                |concat(cast(sum(hh2) / 2692 *100 as decimal(16,3)),'%') as `<=0.1% `,
                                |concat(cast(sum(hh3) / 2692 *100 as decimal(16,3)),'%') as `<=0.3% `,
                                |concat(cast(sum(hh4) / 2692 *100 as decimal(16,3)),'%') as `<=0.5% `,
                                |concat(cast(sum(hh5) / 2692 *100 as decimal(16,3)),'%') as `<=1%  ` ,
                                |concat(cast(sum(hh6) / 2692 *100 as decimal(16,3)),'%') as ` >1%   `
                                |from(
                                |select
                                ...
                                |select
                                |'聚源'          as `基金名称`,
                                |concat(cast(sum(ff1) / 2692 *100 as decimal(16,3)),'%') as `<=0.05%`,
                                |concat(cast(sum(ff2) / 2692 *100 as decimal(16,3)),'%') as `<=0.1% `,
                                |concat(cast(sum(ff3) / 2692 *100 as decimal(16,3)),'%') as `<=0.3% `,
                                |concat(cast(sum(ff4) / 2692 *100 as decimal(16,3)),'%') as `<=0.5% `,
                                |concat(cast(sum(ff5) / 2692 *100 as decimal(16,3)),'%') as `<=1%  ` ,
                                |concat(cast(sum(ff6) / 2692 *100 as decimal(16,3)),'%') as ` >1%   `
                                |from(
                                |select
                                ...
                                |select
                                |'好买'          as `基金名称`,
                                |concat(cast(sum(gg1) / 2692 *100 as decimal(16,3)),'%') as `<=0.05%`,
                                |concat(cast(sum(gg2) / 2692 *100 as decimal(16,3)),'%') as `<=0.1% `,
                                |concat(cast(sum(gg3) / 2692 *100 as decimal(16,3)),'%') as `<=0.3% `,
                                |concat(cast(sum(gg4) / 2692 *100 as decimal(16,3)),'%') as `<=0.5% `,
                                |concat(cast(sum(gg5) / 2692 *100 as decimal(16,3)),'%') as `<=1%  ` ,
                                |concat(cast(sum(gg6) / 2692 *100 as decimal(16,3)),'%') as ` >1%   `
                                |from(
                                |select
